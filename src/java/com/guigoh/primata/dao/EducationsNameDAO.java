 ...
 * @author Joe
 */
public class EducationsNameDAO implements Serializable {

    private transient EntityManagerFactory emf = JPAUtil.getEMF();
    
    public EducationsNameDAO() {
    ...
    public EducationsName findEducationsByName(EducationsName nameId) {
        EntityManager em = getEntityManager();
        try {
            EducationsName educationsNametemp = (EducationsName) em.createNativeQuery("select * from primata_educations_name "
