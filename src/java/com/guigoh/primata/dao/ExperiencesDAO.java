...
public class ExperiencesDAO implements Serializable {
    ...
    public List<Experiences> findExperiencesByTokenId(String token_id) {
        EntityManager em = getEntityManager();
        try {
            List<Experiences> formationsList = (List<Experiences>) em.createNativeQuery("select * from primata_experiences "
    ...
    public void createInsert(Experiences experiences) throws RollbackFailureException, Exception {
        ...
        em.getTransaction().begin();
        try {
            String sql = "INSERT INTO primata_experiences (token_id, name_id, data_begin, data_end, location_id, country_id, state_id, city_id) "
