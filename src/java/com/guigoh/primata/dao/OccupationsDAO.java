 ...
 * @author Joe
 */
public class OccupationsDAO implements Serializable {
    ...
    public List<Occupations> findOccupationsByType(Integer id) {
        EntityManager em = getEntityManager();
        try {
            List<Occupations> cityList = (List<Occupations>) em.createNativeQuery("select * from primata_occupations "
    ...
    public Occupations findOccupationsByName(Occupations occupations) {
        ...
        try {
            ...
            Occupations occupationstemp = (Occupations) em.createNativeQuery("select * from primata_occupations "
     ...
     public Occupations findOccupationsByNameByType(Occupations occupations) {
        ...
        try {
            ...
            List<Occupations> occupationstemp = (List<Occupations>) em.createNativeQuery("select * from primata_occupations "
     ...
     public void createInsert(Occupations occupations) throws RollbackFailureException, Exception {
        ...
        em.getTransaction().begin();
        try {
            String sql = "INSERT INTO primata_occupations( name, occupations_type_id) "
                    + "VALUES( ?1, ?2)";
