...
public class UsersDAO implements Serializable {
    ...
    public void create(Users users) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Authorization authorization = users.getAuthorization();
    ...
    public void edit(Users users) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Authorization authorizationOld = persistentUsers.getAuthorization();
            Authorization authorizationNew = users.getAuthorization();
    ...
    public void destroy(String id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Authorization authorizationOrphanCheck = users.getAuthorization();
