 ...
 */
@Entity
@Table(name = "primata_availability")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Availability.findByDescription", query = "SELECT a FROM Availability a WHERE a.description = :description")})
public class Availability implements Serializable {
    ...
    public Availability(Integer id, String description) {
        this.id = id;
    ...
    public String toString() {
        return "com.guigoh.primata.entity.Availability[ id=" + id + " ]";
    }
