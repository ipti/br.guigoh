...
import com.ipti.guigoh.model.jpa.exceptions.IllegalOrphanException;
...
import com.ipti.guigoh.model.entity.SocialProfileVisibility;
 ...
 * @author Joe
 */
public class SocialProfileVisibilityJpaController implements Serializable {

    public SocialProfileVisibilityJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
