...
import com.ipti.guigoh.model.entity.ContactType;
import com.ipti.guigoh.model.entity.UserContactInfo;
import com.ipti.guigoh.model.entity.UserContactInfoPK;
 ...
 * @author Joe
 */
public class UserContactInfoJpaController implements Serializable {

    public UserContactInfoJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
