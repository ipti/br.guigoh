...
$(document).ready(function(){
    ...
    var inputLabelValue = "";
    if(locale == "ptBR"){inputLabelValue = "Pesquise tópicos ou objetos educacionais..."}
    else if(locale == "enUS"){inputLabelValue = "Search for topics or educational objects..."}
    else if(locale == "frFR"){inputLabelValue = "Rechercher des sujets ou des objets d'apprentissage..."}
